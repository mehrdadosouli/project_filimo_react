  ...
  return (
    <div className='py-10 bg-box'>
        <div className='containers'>
            ...
            {
                films.length && <div className='flex flex-wrap gap-10'>{films.map(elem=><InfoBox key={elem.id} image={elem.image} title={elem.title} author={elem.author} subject={elem.subject} ekran={elem.ekran} />) }</div>
            }
        </div>
    </div>
  )
